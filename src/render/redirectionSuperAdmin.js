...
exports.reset_password = (req, res) => {
  res.render("spa/reset_password_spa", {
    moment: moment,
...
exports.listResponsable = (req, res) => {
  res.render("spa/liste_responsable", {
    role: req.user.role.role,
    moment: moment,
    title: "Gestion Panel- liste responsable",
  });
};
// exports.listClient = (req, res) => {
//   res.render("spa/liste_clients", {
//     role: req.user.role.role,
//     moment: moment,
//     title: "Gestion Panel- liste client",
//   });
// };
exports.nouveauResponsable = (req, res) => {
  cRole.listRoleResponsable().then((data) => {
    res.render("spa/nouveau_responsable", {
      role: req.user.role.role,
      moment: moment,
      title: "Gestion Panel-Nouveau",
      roles: data,
    });
  });
};
...
exports.modificationResponsable = (req, res) => {
  cEmployer.findById(req.params.id).then((data) => {
    res.render("spa/modification_responsable", {
      detail: data,
      role: req.user.role.role,
      moment: moment,
      title: "Gestion Panel-Modification",
    });
  });
};
